...
@section('content')
  ...
  @component('admin.component.breadcrumb')
    @slot('title')
      <h5 class="font-medium text-uppercase mb-0">{{$page->name}} Page Edit</h5>
    @endslot
                              ...
                              <div class="row pt-3">
                                  <div class="col-md-12">
                                      <div class="form-group {{$errors->has('name') ? 'has-danger' : ''}}">
                                          ...
                                          <input type="text" id="lastName" name="name" class="form-control" style="color:#000;" placeholder="Page Name" value="{{$page->name}}">
                                          @if($errors->has('name'))
                                  ...
                                  <div class="col-md-12">
                                      <div class="form-group {{$errors->has('tag') ? 'has-danger' : ''}}">
                                          ...
                                          <input type="text" id="lastName" name="tag" class="form-control" style="color:#000;" placeholder="Page Tag" value="{{$page->page_tag}}">
                                          @if($errors->has('tag'))
